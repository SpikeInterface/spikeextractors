...
class TestExtractors(unittest.TestCase):
    ...
    def _check_recordings_equal(self,RX1,RX2):
        ...
        # getSnippets
        frames=[30,50,80]
        snippets1=RX1.getSnippets(snippet_len_before=10,snippet_len_after=10,center_frames=frames)
        snippets2=RX2.getSnippets(snippet_len_before=10,snippet_len_after=10,center_frames=frames)
